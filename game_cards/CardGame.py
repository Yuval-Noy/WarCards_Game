...
class CardGame:
    ...
    def __init__(self, p1, p2, p1_num_of_cards=26, p2_num_of_cards=26):
        ...
        if type(p1) != Player or type(p2) != Player:
            # Players must be type Player
            raise TypeError("Players must be type Player!")

        if type(p1_num_of_cards) != int or type(p2_num_of_cards) != int:
            # Players number of cards must be type int
            raise TypeError("Players number of cards must be type int!")
        ...
        self.p1 = p1
        self.p2 = p2
        self.p1.number_of_cards = p1_num_of_cards
        self.p2.number_of_cards = p2_num_of_cards
    ...
    def new_game(self):
        ...
        if len(self.hand.deck_of_cards) != 52:
            # If the method activated during a game print ERROR
            raise ValueError("Can not start a new game!")
